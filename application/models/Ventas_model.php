...
class Ventas_model extends CI_Model {
	...
	public function getVentas(){
		$this->db->select("v.*, c.descripcion, tc.Descripcion as tipo_comprobante");
		$this->db->from("ventas v");
		$this->db->join("clientes c", "v.ClienteId = c.id");
		$this->db->join("tipo_comprobante tc", "v.TipoComprobanteId = tc.IdTipoComprobante");
    ...
    public function getVentasbyDate($fechainicio, $fechafin){
    	$this->db->select("v.*, c.Descripcion, tc.Descripcion as tipocomprobante");
		$this->db->from("ventas v");
	...
	public function getVenta($id){
		...
		$this->db->select("v.*, c.nombre, c.Direccion, c.Telefono, c.NroDocumento as documento, tc.nombre as tipocomprobante");
		$this->db->from("ventas v");
		$this->db->join("clientes c", "v.ClienteId = c.IdCliente");
		$this->db->join("tipo_comprobante tc", "v.TipoComprobanteId = tc.IdTipoComprobante"); 
	...
	public function getDetalle($id){
		...
		$this->db->select("dt.*, p.c, p.stockMinimo as stock, p.nombre");
